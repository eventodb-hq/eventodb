...
- `quiet` option for SubscriptionHub to suppress connection state logs (useful for tests)

### Fixed

- SubscriptionHub unit tests no longer interfere with real SSE connections
- Updated to eventodb_ex 0.2.3 with SSE disconnect fix
