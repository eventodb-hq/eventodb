...
defmodule Events.ClassMembershipRejected do
  use Ecto.Schema
  import Ecto.Changeset
  
  @moduledoc """
  Teacher rejects student join request
  ...
  def changeset(data \\ %{}) do
    %__MODULE__{}
    |> cast(data, [:class_id, :student_id, :rejected_at, :rejected_by, :reason])
    |> validate_required([:class_id, :student_id, :rejected_at, :rejected_by])
  end
