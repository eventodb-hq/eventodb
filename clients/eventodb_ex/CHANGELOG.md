...
- SSE subscriptions now properly call `on_error` callback on all disconnect scenarios (connection close, timeout, etc.)

## [0.2.1] - 2025-01-24

### Added

- `subscribe_to_all/2` - subscribe to all events in namespace via SSE (`?all=true`)
