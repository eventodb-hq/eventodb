...
defmodule EventodbEx.TestHelper do
  @moduledoc """
  Helper functions for EventoDB tests.
  """
  ...
  Uses EVENTODB_ADMIN_TOKEN env var to authenticate namespace creation.
  """
  def create_test_namespace(test_name) do
    ...
    client = EventodbEx.Client.new(@base_url, token: result.token)
