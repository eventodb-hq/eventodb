defmodule EventodbEx.EncodingTest do
  ...
  test "ENCODING-003: Special characters in stream name", %{client: client} do
    ...
    result = EventodbEx.stream_write(client, stream, message)
  ...
  test "ENCODING-010: Large message payload", %{client: client} do
    ...
    assert {:ok, _result, client} = EventodbEx.stream_write(client, stream, message)
