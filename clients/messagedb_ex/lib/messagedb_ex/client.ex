defmodule MessagedbEx.Client do
  @moduledoc """
  Low-level HTTP/RPC client for MessageDB.
  """

  alias MessagedbEx.Error
  ...
  @doc """
  Creates a new MessageDB client.
  ...
  ## Examples
      ...
      iex> client = MessagedbEx.Client.new("http://localhost:8080", token: "ns_...")
  ...
  @doc """
  Makes an RPC call to the MessageDB server.
  ...
  defp maybe_capture_token(client, headers) when is_map(headers) do
    ...
    case Map.get(headers, "x-messagedb-token") do
