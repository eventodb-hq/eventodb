...
func (s *PostgresStore) MigrateNamespaces(ctx context.Context) (int, error) {
...
func (s *PostgresStore) migrateNamespaceSchema(ctx context.Context, schemaName string) (int, error) {
...
func (s *PostgresStore) getNamespaceSchemaVersion(ctx context.Context, schemaName string) int {
