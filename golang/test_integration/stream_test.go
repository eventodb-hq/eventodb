...
func TestMDB002_3A_T1_WriteMessageReturnsPosition(t *testing.T) {
	...
	result, err := makeRPCCall(t, ts.Port, ts.Token, "stream.write", "account-123", msg)
	if err != nil {
...
func TestMDB002_3A_T2_WriteWithAutoGeneratedID(t *testing.T) {
	...
	messages, err := makeRPCCall(t, ts.Port, ts.Token, "stream.get", "account-123")
	if err != nil {
...
func TestMDB002_3A_T3_WriteWithExpectedVersionSucceeds(t *testing.T) {
	...
	_, err := makeRPCCall(t, ts.Port, ts.Token, "stream.write", streamName, msg1)
	if err != nil {
	...
	result, err := makeRPCCall(t, ts.Port, ts.Token, "stream.write", streamName, msg2, opts)
	if err != nil {
...
func TestMDB002_3A_T4_WriteWithWrongExpectedVersionFails(t *testing.T) {
	...
	_, err = makeRPCCall(t, ts.Port, ts.Token, "stream.write", streamName, msg2, opts)
	if err == nil {
...
func TestMDB002_3A_T7_GetStreamReturnsMessages(t *testing.T) {
	...
	// Get all messages
	result, err := makeRPCCall(t, ts.Port, ts.Token, "stream.get", streamName)
	if err != nil {
		t.Fatalf("Failed to get messages: %v", err)
	}
...
func TestMDB002_3A_T8_GetWithPositionFilter(t *testing.T) {
	...
	result, err := makeRPCCall(t, ts.Port, ts.Token, "stream.get", streamName, opts)
	if err != nil {
		t.Fatalf("Failed to get messages: %v", err)
	}
...
func TestMDB002_3A_T10_LastMessageReturnsLatest(t *testing.T) {
	...
	// Get last message
	result, err := makeRPCCall(t, ts.Port, ts.Token, "stream.last", streamName)
	if err != nil {
...
func TestMDB002_3A_T11_LastWithTypeFilter(t *testing.T) {
	...
	result, err := makeRPCCall(t, ts.Port, ts.Token, "stream.last", streamName, opts)
	if err != nil {
...
func TestMDB002_3A_T12_VersionReturnsCorrectNumber(t *testing.T) {
	...
	result, err := makeRPCCall(t, ts.Port, ts.Token, "stream.version", streamName)
	if err != nil {
